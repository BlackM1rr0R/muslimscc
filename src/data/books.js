...
export const DEFAULT_BOOKS = [
  {
    ...
    category: 'quran',
    coverUrl: 'https://images.unsplash.com/photo-1609599006353-e629aaabfeae?w=600&q=80',
    pdfUrl: '',
    pages: 604,
    year: 1973,
  },
  {
    ...
    category: 'hadith',
    coverUrl: 'https://images.unsplash.com/photo-1585036156171-384164a8c675?w=600&q=80',
    pdfUrl: '',
    pages: 1860,
    year: 846,
  },
  {
    ...
    category: 'hadith',
    coverUrl: 'https://images.unsplash.com/photo-1564769625905-50e93615e769?w=600&q=80',
    pdfUrl: '',
    pages: 992,
    year: 1273,
  },
  {
    ...
    description: { az:'Hz. Məhəmmədin (s.ə.s.) həyatının ən geniş və mötəbər təsviri.', en:'The most comprehensive biography of Prophet Muhammad (PBUH).', ru:'Самое полное жизнеописание Пророка Мухаммада.', ar:'أشمل سيرة للنبي محمد ﷺ.', tr:'Hz. Muhammed\'in en kapsamlı biyografisi.' },
    category: 'biography',
    coverUrl: 'https://images.unsplash.com/photo-1606819717115-9159c900370b?w=600&q=80',
    pdfUrl: '',
    pages: 580,
    year: 1979,
  },
  {
    ...
    category: 'tasawwuf',
    coverUrl: 'https://images.unsplash.com/photo-1591291621164-2c6367723315?w=600&q=80',
    pdfUrl: '',
    pages: 432,
    year: 1340,
  },
  {
    ...
    category: 'aqida',
    coverUrl: 'https://images.unsplash.com/photo-1565098772267-60af42b81ef2?w=600&q=80',
    pdfUrl: '',
    pages: 48,
    year: 1780,
  },
