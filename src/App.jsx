...
import NotificationSettingsWidget from './components/NotificationSettingsWidget'
...
function AppInner() {
  ...
  return (
    <>
      ...
      {/* Notification settings — above Accessibility button */}
      {!isAdminPage && <NotificationSettingsWidget />}
    </>
  )
}
