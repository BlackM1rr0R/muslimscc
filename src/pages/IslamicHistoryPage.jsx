...
const EVENTS = [
  ...
  { year:{az:'637 e.',en:'637 CE',ru:'637 н.э.',ar:'٦٣٧ م',tr:'MS 637'}, title:{az:'Qadisiyyə döyüşü',en:'Battle of Qadisiyyah',ru:'Битва при Кадисии',ar:'معركة القادسية',tr:'Kâdisiye Savaşı'}, desc:{az:'Sasani imperiyası ilə həlledici döyüş. Səd ibn Əbu Vəqqas komandanlığında müsəlmanlar qələbə qazandı. İraq fəth edildi.',en:'Decisive battle against the Sassanid Empire. Muslims won under Saad ibn Abi Waqqas. Iraq was conquered.',ru:'Решающая битва с Сасанидской империей. Мусульмане победили под командованием Саада ибн Абу Ваккаса. Ирак был завоёван.',ar:'معركة حاسمة ضد الساسانيين. انتصر المسلمون بقيادة سعد بن أبي وقاص. فُتح العراق.',tr:'Sasani İmparatorluğu\'yla belirleyici savaş. Sa\'d bin Ebî Vakkas komutasında Müslümanlar galip geldi.'}, keyFact:{az:'Sasani bayrağı Dərəfşi-Kaviyan ələ keçirildi.',en:'The Sasanid royal banner Derafsh Kaviani was captured.',ru:'Сасанидское царское знамя Дерафш-е Кавиани было захвачено.',ar:'غُنمت راية كسرى الملكية.',tr:'Sasani kraliyet sancağı ele geçirildi.'} },
