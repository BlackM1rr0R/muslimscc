...
const PLACES = [
  ...
  },
  {
    ...
    desc: {
      az:'Peyğəmbərimiz Hz. Məhəmmədin (s.ə.s) Mədinəyə hicrət etdikdən sonra inşa etdiyi məscid. İslam tarixinin ən mühüm məscidlərindən biridir. Peyğəmbərimizin məzarı burada yerləşir.',
      ...
      tr:'Hz. Muhammed\'in (s.a.v.) Medine\'ye hicretinden sonra inşa ettiği mescid. İslam tarihinin en önemli mescitlerinden biridir. Hz. Peygamber\'in kabri burada bulunmaktadır.',
    },
    significance: {
  ...
  },
  {
    ...
    desc: {
      az:'İslamda üçüncü ən müqəddəs yer. Peyğəmbərimizin (s.ə.s) İsra və Merac gecəsində ziyarət etdiyi məsciddir. İlk qiblə istiqaməti olaraq bilinir.',
      ...
      tr:'İslam\'da üçüncü en kutsal mekân. Hz. Peygamber\'in (s.a.v.) İsra ve Miraç gecesinde ziyaret ettiği mescittir. İlk kıble yönü olarak bilinir.',
    },
    significance: {
      az:'Peyğəmbərlərin toplandığı və Hz. Məhəmmədin (s.ə.s) onlara imam olub namaz qıldırdığı yer.',
      ...
      tr:'Peygamberlerin toplandığı ve Hz. Muhammed\'in (s.a.v.) onlara imam olarak namaz kıldırdığı yer.',
    },
  ...
  },
  {
    ...
    city: { az:'Mədinə', en:'Medina', ru:'Медина', ar:'المدينة المنورة', tr:'Medine' },
    desc: {
      az:'İslam tarixində inşa edilən ilk məscid. Peyğəmbərimiz (s.ə.s) Mədinəyə hicrəti zamanı burada dayanıb bu məscidi inşa etmişdir. Qurani-Kərimdə təqva üzərində qurulmuş məscid olaraq xatırlanır.',
      ...
      tr:'İslam tarihinde inşa edilen ilk mescit. Hz. Peygamber (s.a.v.) Medine\'ye hicreti sırasında burada durarak bu mescidi inşa etmiştir. Kur\'an\'da takva üzere kurulmuş mescit olarak anılır.',
    },
    significance: {
  ...
  },
  {
    ...
    city: { az:'Məkkə', en:'Mecca', ru:'Мекка', ar:'مكة المكرمة', tr:'Mekke' },
    desc: {
      az:'Peyğəmbərimizə (s.ə.s) ilk vəhyin nazil olduğu mağara. Nur dağının zirvəsində yerləşir. Hz. Məhəmməd (s.ə.s) burada ibadət və təfəkkür edərdi.',
      ...
      tr:'Hz. Peygamber\'e (s.a.v.) ilk vahyin indirildiği mağara. Nur Dağı\'nın zirvesinde yer alır. Hz. Muhammed (s.a.v.) burada ibadet ve tefekkür ederdi.',
    },
    significance: {
  ...
  },
  {
    ...
    city: { az:'Məkkə', en:'Mecca', ru:'Мекка', ar:'مكة المكرمة', tr:'Mekke' },
    desc: {
      az:'Hz. Məhəmməd (s.ə.s) və Hz. Əbu Bəkr (r.a) Mədinəyə hicrət edərkən üç gün gizləndikləri mağara. Allah-Təala onları müşriklərin gözündən qorumuşdur.',
      ...
      tr:'Hz. Muhammed (s.a.v.) ve Hz. Ebu Bekir\'in (r.a.) Medine\'ye hicret ederken üç gün gizlendikleri mağara. Allah onları müşriklerin gözünden korumuştur.',
    },
    significance: {
  ...
  },
  {
    ...
    city: { az:'Məkkə', en:'Mecca', ru:'Мекка', ar:'مكة المكرمة', tr:'Mekke' },
    desc: {
      az:'Həccin ən mühüm rüknü olan Ərafat dayanması burada edilir. Peyğəmbərimiz (s.ə.s) Vida Xütbəsini burada söyləmişdir. Zilhiccə ayının 9-cu günü milyonlarla müsəlman burada toplanır.',
      ...
      tr:'Haccın en önemli rüknü olan Arafat vakfesi burada yapılır. Hz. Peygamber (s.a.v.) Veda Hutbesi\'ni burada okumuştur. Zilhicce ayının 9. günü milyonlarca Müslüman burada toplanır.',
    },
    significance: {
  ...
  },
  {
    ...
    city: { az:'Mədinə', en:'Medina', ru:'Медина', ar:'المدينة المنورة', tr:'Medine' },
    desc: {
      az:'Mədinədə yerləşən ən qədim və ən müqəddəs İslam qəbiristanlığı. Peyğəmbərimizin (s.ə.s) ailə üzvləri, səhabələr və tabeinlər burada dəfn edilmişdir. On mindən çox səhabənin məzarı burada yerləşir.',
      ...
      tr:'Medine\'deki en eski ve en kutsal İslam kabristanı. Hz. Peygamber\'in (s.a.v.) aile üyeleri, sahâbîler ve tâbiîn burada defnedilmiştir. On binden fazla sahâbînin kabri burada bulunmaktadır.',
    },
    significance: {
      az:'Peyğəmbərimiz (s.ə.s) tez-tez buranı ziyarət edər və Bəqi əhli üçün dua edərdi.',
      ...
      tr:'Hz. Peygamber (s.a.v.) burayı sık sık ziyaret eder ve Bakî ehli için dua ederdi.',
    },
